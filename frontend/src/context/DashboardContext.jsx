...
export const DashboardProvider = ({ children }) => {
  ...
  useEffect(() => {
    const fetchApiData = async () => {
      const token = localStorage.getItem('vb_token') || '5b3f7a1e0bca4876b6de52382c75a89274534ef0da05cf14e7a89270df8276f3';
      const headers = {
  ...
  const addVendor = useCallback(async (vendorData) => {
    ...
    try {
      ...
      const activeToken = localStorage.getItem('vb_token') || '5b3f7a1e0bca4876b6de52382c75a89274534ef0da05cf14e7a89270df8276f3';
      const apiBase = import.meta.env.VITE_API_URL || (window.location.origin.includes('localhost:5173') 
        ? 'http://localhost:8000' 
        : window.location.origin);
