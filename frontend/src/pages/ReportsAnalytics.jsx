...
export default function ReportsAnalytics() {
  ...
  const handleExportPDF = () => {
    addToast('Opening print dialog to export Executive Spend Report PDF...', 'success');
    setTimeout(() => {
      window.print();
    }, 500);
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold font-heading text-slate-900 dark:text-Black">Procurement Analytics</h1>
